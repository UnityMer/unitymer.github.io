...
console.log("%c%c博客主题样式%chttps://www.cnblogs.com/yjlaugus/p/13466375.html", "line-height:28px;", "line-height:28px;padding:4px;background:#222;color:#fff;font-size:16px;margin-right:15px", "color:#ff9900;line-height:28px;font-size:16px;");
